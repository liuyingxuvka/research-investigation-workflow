...
def current_artifacts(skill_version: str = "1", project_copy_version: str = "1"):
    return (
        ...
        ProcessArtifact(
            ...
            PROCESS_ARTIFACT_REQUIREMENT,
            "1",
            path="openspec/changes/add-research-investigation-workflow-skill",
            owner="openspec",
            upstream_artifact_ids=("requirements.project-plan",),
            description="OpenSpec proposal, design, spec, and task contract.",
        ),
        ProcessArtifact(
        ...
        ProcessArtifact(
            ...
            PROCESS_ARTIFACT_CODE,
            skill_version,
            path="C:/Users/liu_y/.codex/skills/research-investigation-workflow",
            owner="skill-creator",
        ...
        ProcessArtifact(
            ...
            PROCESS_ARTIFACT_TEST,
            "1",
            path="C:/Users/liu_y/.codex/skills/.system/skill-creator/scripts/quick_validate.py",
            owner="skill-creator",
...
def implementation_plan() -> DevelopmentProcessPlan:
    return DevelopmentProcessPlan(
        ...
        artifacts=current_artifacts(skill_version="1", project_copy_version="1"),
        actions=(
            ProcessAction(
        ...
        evidence=(
            ...
            ProcessEvidence(
                ...
                covered_versions={"model.flowguard-preflight": "1", "model.flowguard-process": "1"},
            ...
            ProcessEvidence(
                ...
                command="python C:/Users/liu_y/.codex/skills/.system/skill-creator/scripts/quick_validate.py C:/Users/liu_y/.codex/skills/research-investigation-workflow",
                proof_artifact=proof_artifact(
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.installed-skill": "1", "doc.project-skill-copy": "1"},
            ...
            ProcessEvidence(
                ...
                status=PROCESS_EVIDENCE_PASSED,
                covers_artifacts=("code.installed-skill",),
                covered_versions={"code.installed-skill": "1"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"requirements.openspec": "1"},
                validation_requirement_ids=("openspec-current",),
                produced_by_action_id="run-validation",
                command="openspec validate add-research-investigation-workflow-skill --strict",
                proof_artifact=proof_artifact(
                    "artifact:openspec-validate-pass",
                    "openspec validate add-research-investigation-workflow-skill --strict",
