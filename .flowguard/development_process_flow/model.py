"""FlowGuard DevelopmentProcessFlow for layered research evidence upgrades.
...
def current_artifacts(skill_version: str = "1", project_copy_version: str = "1"):
    return (
        ...
        ProcessArtifact(
            ...
            PROCESS_ARTIFACT_REQUIREMENT,
            "6",
            path="openspec/changes/strengthen-layered-research-evidence-contract",
            owner="openspec",
            upstream_artifact_ids=("requirements.project-plan",),
            description="OpenSpec proposal, design, spec, and task contract for source portfolios, key-claim ledgers, semantic-fit checks, layered TraceGuard/LogicGuard use, and genre-adaptive synthesis.",
        ),
        ProcessArtifact(
            ...
            description="Existing model ownership route decision for layered evidence contracts across Research workflow, SourceGuard, TraceGuard, LogicGuard, and FlowGuard process boundaries.",
        ),
        ProcessArtifact(
            ...
            description="Lifecycle freshness model for layered evidence contract implementation, install sync, validation, and closure.",
        ),
        ProcessArtifact(
        ...
        ProcessArtifact(
            ...
            owner="skill-creator",
            upstream_artifact_ids=("requirements.openspec", "model.flowguard-preflight"),
            description="Installed Guard-family skill files touched by source portfolio, layered TraceGuard, hierarchical LogicGuard, and semantic-fit guidance.",
        ),
        ProcessArtifact(
            "code.audit-helpers",
            PROCESS_ARTIFACT_CODE,
            ...
            owner="skill-creator",
            upstream_artifact_ids=("requirements.openspec",),
            description="Lightweight source portfolio, key-claim ledger, and claim/source semantic-fit helpers.",
        ),
        ProcessArtifact(
            "tests.layered-evidence-regression",
            PROCESS_ARTIFACT_TEST,
            "1",
            path="OpenSpec scenarios; helper smoke fixtures; targeted text checks for data-center mismatch patterns",
            owner="project",
            description="Regression checks for portfolio coverage, key-number provenance, semantic source-fit, layered Guard modeling, and AI data-center report mismatch risks.",
        ),
        ProcessArtifact(
...
def implementation_plan() -> DevelopmentProcessPlan:
    return DevelopmentProcessPlan(
        "layered-research-evidence-contract-lifecycle",
        require_proof_artifacts=True,
        artifacts=current_artifacts(skill_version="6", project_copy_version="6"),
        actions=(
            ProcessAction(
            ...
            ProcessAction(
                ...
                invalidates_evidence=("skill-validate-pass", "smoke-review-pass", "sync-hash-pass", "helper-smoke-pass", "layered-evidence-regression-pass"),
            ...
            ProcessAction(
                "run-validation",
                reads_artifacts=("code.installed-skill", "code.guard-installed-skills", "code.audit-helpers", "doc.project-skill-copy", "tests.skill-validator", "tests.layered-evidence-regression"),
                produced_evidence_ids=("skill-validate-pass", "smoke-review-pass", "openspec-validate-pass", "helper-smoke-pass", "layered-evidence-regression-pass"),
            ...
            ProcessAction(
                ...
                required_validation_ids=(
                    ...
                    "layered-evidence-regression-current",
                ),
        ...
        evidence=(
            ...
            ProcessEvidence(
                ...
                covered_versions={"model.flowguard-preflight": "6", "model.flowguard-process": "6"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.installed-skill": "6", "tests.skill-validator": "1"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.installed-skill": "6", "code.guard-installed-skills": "6", "code.audit-helpers": "6", "doc.project-skill-copy": "6"},
            ...
            ProcessEvidence(
                ...
                status=PROCESS_EVIDENCE_PASSED,
                covers_artifacts=("code.installed-skill",),
                covered_versions={"code.installed-skill": "6"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"requirements.openspec": "6"},
                validation_requirement_ids=("openspec-current",),
                produced_by_action_id="run-validation",
                command="openspec validate strengthen-layered-research-evidence-contract --strict",
                proof_artifact=proof_artifact(
                    "artifact:openspec-validate-pass",
                    "openspec validate strengthen-layered-research-evidence-contract --strict",
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.audit-helpers": "6"},
                validation_requirement_ids=("helper-smoke-current",),
                produced_by_action_id="run-validation",
                command="Run known-good and known-bad source portfolio, key-claim, and semantic-fit helper fixtures",
                proof_artifact=proof_artifact(
                    "artifact:helper-smoke-pass",
                    "Run known-good and known-bad source portfolio, key-claim, and semantic-fit helper fixtures",
                    "console:helper-smoke",
                    "helper-smoke-current",
                ),
            ),
            ProcessEvidence(
                "layered-evidence-regression-pass",
                evidence_kind="layered_evidence_regression",
                producer_route="development_process_flow",
                status=PROCESS_EVIDENCE_PASSED,
                covers_artifacts=("code.installed-skill", "code.guard-installed-skills", "tests.layered-evidence-regression"),
                covered_versions={"code.installed-skill": "6", "code.guard-installed-skills": "6", "tests.layered-evidence-regression": "1"},
                validation_requirement_ids=("layered-evidence-regression-current",),
                produced_by_action_id="run-validation",
                command="Run targeted rg checks for portfolio, key-claim, semantic-fit, layered TraceGuard, hierarchical LogicGuard, genre-adaptive review, and data-center mismatch patterns",
                proof_artifact=proof_artifact(
                    "artifact:layered-evidence-regression-pass",
                    "Run targeted rg checks for layered evidence contract coverage",
                    "console:layered-evidence-regression",
                    "layered-evidence-regression-current",
                ),
            ),
        ),
        validation_requirements=(
            ...
            ValidationRequirement(
                ...
                v_model_pair=True,
                command="Run helper smoke tests on known-good and known-bad ledger fixtures.",
            ),
            ValidationRequirement(
                "layered-evidence-regression-current",
                required_artifact_ids=("code.installed-skill", "code.guard-installed-skills", "tests.layered-evidence-regression"),
                required_evidence_kinds=("layered_evidence_regression",),
                v_model_pair=True,
                command="Run targeted text checks for layered evidence and data-center mismatch coverage.",
            ),
        ),
        freshness_rules=(
            FreshnessRule(
            ...
            FreshnessRule(
                ...
                invalidates_evidence_kinds=("flowguard", "skill_validation", "manual_smoke_review", "sync_hash", "helper_smoke", "layered_evidence_regression"),
            ),
            FreshnessRule(
            ...
            FreshnessRule(
                ...
                invalidates_evidence_kinds=("helper_smoke", "sync_hash", "layered_evidence_regression"),
            ),
            FreshnessRule(
