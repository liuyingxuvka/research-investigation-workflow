...
def current_artifacts(skill_version: str = "1", project_copy_version: str = "1"):
    return (
        ...
        ProcessArtifact(
            ...
            PROCESS_ARTIFACT_REQUIREMENT,
            "3",
            path="openspec/changes/integrate-sourceguard-discovery-loop",
            owner="openspec",
            upstream_artifact_ids=("requirements.project-plan",),
            description="OpenSpec proposal, design, spec, and task contract for SourceGuard discovery orchestration.",
        ),
        ProcessArtifact(
            ...
            description="Existing model ownership route decision including SourceGuard, TraceGuard, LogicGuard, and FlowGuard boundaries.",
        ),
        ProcessArtifact(
...
def implementation_plan() -> DevelopmentProcessPlan:
    return DevelopmentProcessPlan(
        ...
        artifacts=current_artifacts(skill_version="3", project_copy_version="3"),
        actions=(
            ProcessAction(
        ...
        evidence=(
            ...
            ProcessEvidence(
                ...
                covered_versions={"model.flowguard-preflight": "3", "model.flowguard-process": "3"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.installed-skill": "3", "tests.skill-validator": "1"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"code.installed-skill": "3", "doc.project-skill-copy": "3"},
            ...
            ProcessEvidence(
                ...
                status=PROCESS_EVIDENCE_PASSED,
                covers_artifacts=("code.installed-skill",),
                covered_versions={"code.installed-skill": "3"},
            ...
            ProcessEvidence(
                ...
                covered_versions={"requirements.openspec": "3"},
                validation_requirement_ids=("openspec-current",),
                produced_by_action_id="run-validation",
                command="openspec validate integrate-sourceguard-discovery-loop --strict",
                proof_artifact=proof_artifact(
                    "artifact:openspec-validate-pass",
                    "openspec validate integrate-sourceguard-discovery-loop --strict",
