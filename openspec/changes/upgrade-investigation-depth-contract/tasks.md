...
- [x] 3.1 Sync the project-local `research-investigation-workflow` skill to the installed skill path and verify file parity.
- [x] 3.2 Update the TraceGuard local repository and installed TraceGuard skill guidance for logic-lead/evidence-chain handoff.
- [x] 3.3 Update the LogicGuard local repository and installed LogicGuard guidance for citation-grounded deep report writing.

## 4. Validation

- [x] 4.1 Run skill validation for every upgraded installed/project skill surface.
- [x] 4.2 Run OpenSpec strict validation for `upgrade-investigation-depth-contract`.
- [x] 4.3 Run FlowGuard package/project preflight and project audit.
- [x] 4.4 Run targeted text checks proving the required deep-investigation, citation, TraceGuard, LogicGuard, FlowGuard, and privacy instructions exist.
- [x] 4.5 Verify generated investigation outputs remain ignored and untracked.

## 5. Git And Postflight

- [x] 5.1 Commit software-only changes in the research-investigation-workflow repository.
- [x] 5.2 Commit software-only changes in the TraceGuard repository if it changed.
- [x] 5.3 Commit software-only changes in the LogicGuard repository if it changed.
- [x] 5.4 Record KB postflight observations for reusable skill-upgrade lessons.
